...
if (isset($_POST['g-recaptcha-response']) && ! empty($_POST['g-recaptcha-response'])) {
    ...
    if ($responseData->success) {
        ...
        $arrResult = ['response'=>'error', 'errorMessage'=>'Robot verification failed, please try again'];
        echo json_encode($arrResult);
    }
} else {
    $arrResult = ['response'=>'error', 'errorMessage'=>'Please click on the reCAPTCHA box.'];
    echo json_encode($arrResult);
}
