...
jQuery(document).ready(function() {
    ...
    }), $(".qtyminus").click(function(e) { e.preventDefault(), fieldName = $(this).attr("name"); var a = parseInt($("input[name=" + fieldName + "]").val());!isNaN(a) && a > 0 ? $("input[name=" + fieldName + "]").val(a - 1) : $("input[name=" + fieldName + "]").val(0) })
});
...
(function(h) {
    ...
    h.number =
        function(f, a, c, k) {
            ...
            f = !isFinite(+f) ? 0 : +f;
            j = "";
            j = function(p, b) { var d = Math.pow(10, b); return "" + Math.round(p * d) / d };
