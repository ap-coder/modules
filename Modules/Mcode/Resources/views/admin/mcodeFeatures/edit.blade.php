...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("mcode:admin.mcode-features.update", [$mcodeFeature->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                <label for="models">{{ trans('cruds.mcodeFeature.fields.models') }}</label>
                <div style="padding-bottom: 4px">
                    <span class="btn btn-info btn-xs select-all" style="border-radius: 0">{{ trans('global.select_all') }}</span>
                    <span class="btn btn-info btn-xs deselect-all" style="border-radius: 0">{{ trans('global.deselect_all') }}</span>
                </div>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.mcodeFeature.fields.models_helper') }}</span>
            </div>
            <div class="form-group">
