...
<div class="card">
    <div class="card-header">
        {{ trans('mcode::global.create') }} {{ trans('mcode::cruds.mcodeCategory.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.mcode-categories.store") }}" enctype="multipart/form-data">
            @csrf
...
<script>
    ...
    init: function () {
@if(isset($mcodeCategory) && $mcodeCategory->image)
      var file = {!! json_encode($mcodeCategory->image) !!}
