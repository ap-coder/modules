        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    {{ trans('global.edit') }} {{ trans('cruds.mCodeProduct.title_singular') }}
                </div>

                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.m-code-products.update", [$mCodeProduct->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="product_id" id="product_id">
                                @foreach($products as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('product_id') ? old('product_id') : $mCodeProduct->product->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="pdf_cover" id="pdf_cover" value="{{ old('pdf_cover', $mCodeProduct->pdf_cover) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="pdf_nicename" id="pdf_nicename" value="{{ old('pdf_nicename', $mCodeProduct->pdf_nicename) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="product_image" id="product_image" value="{{ old('product_image', $mCodeProduct->product_image) }}">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="published" id="published" value="1" {{ $mCodeProduct->published || old('published', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="model_id" id="model_id">
                                @foreach($models as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('model_id') ? old('model_id') : $mCodeProduct->model->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                            @if($errors->has('model'))
                                <div class="invalid-feedback">
