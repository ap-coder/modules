        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    {{ trans('global.edit') }} {{ trans('cruds.mCodeFeature.title_singular') }}
                </div>

                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.m-code-features.update", [$mCodeFeature->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label for="name">{{ trans('cruds.mCodeFeature.fields.name') }}</label>
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $mCodeFeature->name) }}">
                            @if($errors->has('name'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="code" id="code" value="{{ old('code', $mCodeFeature->code) }}">
                            @if($errors->has('code'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('code') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="category" id="category" value="{{ old('category', $mCodeFeature->category) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="template" id="template" value="{{ old('template', $mCodeFeature->template) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="feature_name" id="feature_name" value="{{ old('feature_name', $mCodeFeature->feature_name) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="feature_code" id="feature_code" value="{{ old('feature_code', $mCodeFeature->feature_code) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="description" id="description">{!! old('description', $mCodeFeature->description) !!}</textarea>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="published" id="published" value="1" {{ $mCodeFeature->published || old('published', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="mcode_categories[]" id="mcode_categories" multiple>
                                @foreach($mcode_categories as $id => $mcode_categories)
                                    <option value="{{ $id }}" {{ (in_array($id, old('mcode_categories', [])) || $mCodeFeature->mcode_categories->contains($id)) ? 'selected' : '' }}>{{ $mcode_categories }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="order" id="order" value="{{ old('order', $mCodeFeature->order) }}" step="1">
                            @if($errors->has('order'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('order') }}
                                </div>
